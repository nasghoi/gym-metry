    ...
    return (
        <>
            ...
            <ul className="rules-list">
                ...
                <div className="rule-item">
                    <p><b>Weight*</b></p>
                    <p>Select maximum weight that allows you to complete the the set with good form</p>
                </div>
            </ul>
            <small>* The first and second set shoud be at 75% and 85% of your working weight used for the last two sets.</small>
            <h3>The Training Plan</h3>
            <p>This training plan uses a structure know as the <b>Bro Split</b>, and follows this rotation</p>
